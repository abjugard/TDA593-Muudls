...
/*
 * RELATE FACILITY TO FACILITYTYPE ACROSS R1
 */
void
HotelComponent_FACILITYTYPE_R1_Link_is_instance_of( HotelComponent_FACILITY * part, HotelComponent_FACILITYTYPE * form )
{
  if ( (part == 0) || (form == 0) ) {
    XTUML_EMPTY_HANDLE_TRACE( "FACILITYTYPE", "HotelComponent_FACILITYTYPE_R1_Link_is_instance_of" );
    return;
  }
  /* Note:  FACILITYTYPE->FACILITY[R1] not navigated */
