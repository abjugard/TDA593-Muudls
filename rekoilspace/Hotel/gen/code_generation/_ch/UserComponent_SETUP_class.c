 ...
 * State 3:  [SetupState]
 */
static void UserComponent_SETUP_act3( UserComponent_SETUP *, const Escher_xtUMLEvent_t * const );
static void
UserComponent_SETUP_act3( UserComponent_SETUP * self, const Escher_xtUMLEvent_t * const event )
{
  /* SEND Port1::addFacilityType(approximateArea:10-12 m^2, description:ASBRA, id:0, name:Single Room, price:1500) */
...
const Escher_xtUMLEventConstant_t UserComponent_SETUPevent2c = {
  UserComponent_DOMAIN_ID, UserComponent_SETUP_CLASS_NUMBER, USERCOMPONENT_SETUPEVENT2NUM,
  ESCHER_IS_INSTANCE_EVENT };
 ...
 */
static const Escher_SEMcell_t UserComponent_SETUP_StateEventMatrix[ 3 + 1 ][ 2 ] = {
  /* row 0:  uninitialized state (for creation events) */
  { EVENT_CANT_HAPPEN, EVENT_CANT_HAPPEN },
  /* row 1:  UserComponent_SETUP_STATE_1 (Startup) */
  { EVENT_CANT_HAPPEN, UserComponent_SETUP_STATE_3 },
  /* row 2:  UserComponent_SETUP_STATE_2 (CreateFacilities) */
  { UserComponent_SETUP_STATE_2, EVENT_CANT_HAPPEN },
  /* row 3:  UserComponent_SETUP_STATE_3 (SetupState) */
  { UserComponent_SETUP_STATE_2, EVENT_CANT_HAPPEN }
};
   ...
   */
  static const StateAction_t UserComponent_SETUP_acts[ 4 ] = {
    (StateAction_t) 0,
    (StateAction_t) UserComponent_SETUP_act1,  /* Startup */
    (StateAction_t) UserComponent_SETUP_act2,  /* CreateFacilities */
    (StateAction_t) UserComponent_SETUP_act3  /* SetupState */
  };
    ...
    if ( current_state > 3 ) {
      ...
      if ( next_state <= 3 ) {
        ...
        instance->current_state = next_state;
          ...
          STATE_TXN_CH_TRACE( "SETUP", current_state );
      } else {
        /* empty else */
      }
    }
