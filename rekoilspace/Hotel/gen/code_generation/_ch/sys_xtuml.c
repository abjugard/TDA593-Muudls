...
Escher_Extent_t * const * const domain_class_info[ SYSTEM_DOMAIN_COUNT ] = {
  &HotelComponent_class_info[0],
  &PaymentServiceProviderComponent_class_info[0],
  &UserComponent_class_info[0]
};
...
typedef union {
  ...
  PaymentServiceProviderComponent_DomainEvents_u mc_events_in_domain_PaymentServiceProviderComponent;
...
static void ooa_loop( void )
{
  ...
  static const EventTaker_t * DomainClassDispatcherTable[ 3 ] =
    {
      HotelComponent_EventDispatcher,
      PaymentServiceProviderComponent_EventDispatcher,
      UserComponent_EventDispatcher
    };
  Escher_xtUMLEvent_t * event;
